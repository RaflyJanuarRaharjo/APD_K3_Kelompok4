...
def run(args):
    ...
    # ── TATA LETAK JENDELA OPENCV (Tambahkan di sini) ──────────────────
    # Membuat nama jendela yang statis
    window_name = "APD Monitor K3 – Kelompok 04"
    # Mengatur jendela agar bisa di-resize secara fleksibel
    cv2.namedWindow(window_name, cv2.WINDOW_NORMAL)
    # Memaksa ukuran jendela menjadi lebih besar (Contoh: HD 1280x720)
